    ...
    <div class="col-sm-12 mb-md-0 mb-4">
      <div class="card">
        <div class="card-header pb-0">
          <div class="row">
            <div class="col-lg-6 col-sm-12 col-md-7">
              <h6 id="cardFormTitle">Add Alternatif</h6>
              <p class="text-sm mb-0 d-none d-md-block">
                <i class="fa fa-check text-info" aria-hidden="true"></i>
              ...
              <div class="row mx-0">
                <div class="col-md-6 col-sm-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value="" id="nama" name="nama" placeholder="Nama Alternatif" required />
                  </div>
                </div>
                <div class="col-md-6 col-sm-12">
                  <div class="form-group">
